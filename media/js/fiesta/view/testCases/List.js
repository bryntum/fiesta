Ext.define('Fiesta.view.testCases.List', {
    ...
    columns: [
    
        {
            ...
            text: "Tests",
            tpl: [ 
                '<div style="font-size: 14px; font-weight: bold; position: relative">',
                '<div style="font-size: 10px; position: absolute; right: 0px; color: rgb(207, 207, 207); top: -5px;">04/01/2013</div>',
                '<p style="margin-bottom: 0px; clear: both; font-size: 14px; margin-top: 5px; white-space: normal; margin-right: 55px;">{name}</p>',
